...
from cachenew import cache  # Import cache from cache.py
from utils import zillow_data, broker_data, get_unique_cities
# Import Blueprints
...
app.register_blueprint(carousel_api)
...
# # from data_loader import zillow_data, broker_data, get_unique_cities
...
#     try:
#         # Correct usage of cache to retrieve saved searches
#         saved_searches = cache.get('saved_searches') or []
...
#         # Update the cache with the new saved searches
#         cache.set('saved_searches', saved_searches)
